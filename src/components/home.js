...
<p style={headerDetailStyle} >The open source code and project for OpenTDF are hosted at <a style={linkStyle} href="https://github.com/opentdf">GitHub here</a>. If you want to jump directly into building out an OpenTDF environment, the best place to start is the <a style={linkStyle} href="https://github.com/opentdf/opentdf/tree/main/quickstart">Quickstart Guide here</a>. To get a better idea of what you can do with OpenTDF, and some example code of how to do it, refer to the Example Projects.</p>
...
<p style={headerDetailStyle} >If there’s something specific you’d love to see, please get involved. Join the <a style={linkStyle} href="https://twitter.com/openTDF">conversation on Twitter</a> or in the <a style={linkStyle} href="https://join.slack.com/t/opentdf/shared_invite/zt-1e3jhnedw-wjviK~qRH_T1zG4dfaa~3A">OpenTDF Slack community</a>!</p>
      </div>
    </div>
  );
}
